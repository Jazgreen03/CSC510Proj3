  ...
  return (
    <div className="orders-container" role="main" aria-labelledby="orders-heading">
      ...
      {filteredOrders.length === 0 ? (
        <div className="no-orders" role="status" id="orders-panel" role="tabpanel">
          <p>No orders found.</p>
        ...
        <div className="orders-list" role="region" aria-label={`${filteredOrders.length} orders displayed`} id="orders-panel" role="tabpanel">
